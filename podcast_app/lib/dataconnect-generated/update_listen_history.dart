...
class UpdateListenHistoryVariablesBuilder {
  ...
  UpdateListenHistoryVariablesBuilder(this._dataConnect, {required  this.userId,required  this.episodeId,required  this.progressSeconds,required  this.finishedListening,required  this.listenedAt,});
  Deserializer<UpdateListenHistoryData> dataDeserializer = (dynamic json)  => UpdateListenHistoryData.fromJson(jsonDecode(json));
  Serializer<UpdateListenHistoryVariables> varsSerializer = (UpdateListenHistoryVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpdateListenHistoryData, UpdateListenHistoryVariables>> execute() {
    return ref().execute();
  }

  MutationRef<UpdateListenHistoryData, UpdateListenHistoryVariables> ref() {
    UpdateListenHistoryVariables vars= UpdateListenHistoryVariables(userId: userId,episodeId: episodeId,progressSeconds: progressSeconds,finishedListening: finishedListening,listenedAt: listenedAt,);
    return _dataConnect.mutation("UpdateListenHistory", dataDeserializer, varsSerializer, vars);
  }
}
...
class UpdateListenHistoryListenHistoryUpsert {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateListenHistoryListenHistoryUpsert otherTyped = other as UpdateListenHistoryListenHistoryUpsert;
...
class UpdateListenHistoryData {
  ...
  listenHistory_upsert = UpdateListenHistoryListenHistoryUpsert.fromJson(json['listenHistory_upsert']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
...
class UpdateListenHistoryVariables {
  ...
  bool operator ==(Object other) {
    ...
    final UpdateListenHistoryVariables otherTyped = other as UpdateListenHistoryVariables;
    return userId == otherTyped.userId && 
    episodeId == otherTyped.episodeId && 
  ...
  @override
  int get hashCode => Object.hashAll([userId.hashCode, episodeId.hashCode, progressSeconds.hashCode, finishedListening.hashCode, listenedAt.hashCode]);
