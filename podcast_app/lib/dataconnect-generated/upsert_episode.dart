...
class UpsertEpisodeVariablesBuilder {
  ...
  UpsertEpisodeVariablesBuilder(this._dataConnect, {required  this.podcastId,required  this.title,required  this.audioUrl,required  this.duration,required  this.publishedAt,});
  Deserializer<UpsertEpisodeData> dataDeserializer = (dynamic json)  => UpsertEpisodeData.fromJson(jsonDecode(json));
  Serializer<UpsertEpisodeVariables> varsSerializer = (UpsertEpisodeVariables vars) => jsonEncode(vars.toJson());
  ...
  MutationRef<UpsertEpisodeData, UpsertEpisodeVariables> ref() {
    UpsertEpisodeVariables vars= UpsertEpisodeVariables(id: _id,podcastId: podcastId,title: title,audioUrl: audioUrl,duration: duration,description: _description,imageUrl: _imageUrl,publishedAt: publishedAt,);
    return _dataConnect.mutation("UpsertEpisode", dataDeserializer, varsSerializer, vars);
  }
}
...
class UpsertEpisodeEpisodeUpsert {
  ...
  bool operator ==(Object other) {
    ...
    final UpsertEpisodeEpisodeUpsert otherTyped = other as UpsertEpisodeEpisodeUpsert;
...
class UpsertEpisodeData {
  ...
  episode_upsert = UpsertEpisodeEpisodeUpsert.fromJson(json['episode_upsert']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
...
class UpsertEpisodeVariables {
  ...
  @override
  int get hashCode => Object.hashAll([id.hashCode, podcastId.hashCode, title.hashCode, audioUrl.hashCode, duration.hashCode, description.hashCode, imageUrl.hashCode, publishedAt.hashCode]);
