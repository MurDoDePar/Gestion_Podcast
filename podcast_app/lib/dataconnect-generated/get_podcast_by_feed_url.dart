...
class GetPodcastByFeedUrlVariablesBuilder {
  ...
  GetPodcastByFeedUrlVariablesBuilder(this._dataConnect, {required  this.feedUrl,});
  Deserializer<GetPodcastByFeedUrlData> dataDeserializer = (dynamic json)  => GetPodcastByFeedUrlData.fromJson(jsonDecode(json));
  Serializer<GetPodcastByFeedUrlVariables> varsSerializer = (GetPodcastByFeedUrlVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<GetPodcastByFeedUrlData, GetPodcastByFeedUrlVariables>> execute() {
    return ref().execute();
  }

  QueryRef<GetPodcastByFeedUrlData, GetPodcastByFeedUrlVariables> ref() {
    GetPodcastByFeedUrlVariables vars= GetPodcastByFeedUrlVariables(feedUrl: feedUrl,);
    return _dataConnect.query("GetPodcastByFeedUrl", dataDeserializer, varsSerializer, vars);
  }
}
...
class GetPodcastByFeedUrlPodcasts {
  ...
  bool operator ==(Object other) {
    ...
    final GetPodcastByFeedUrlPodcasts otherTyped = other as GetPodcastByFeedUrlPodcasts;
  ...
  @override
  int get hashCode => Object.hashAll([id.hashCode, title.hashCode, feedUrl.hashCode, imageUrl.hashCode]);
...
class GetPodcastByFeedUrlVariables {
  ...
  bool operator ==(Object other) {
    ...
    final GetPodcastByFeedUrlVariables otherTyped = other as GetPodcastByFeedUrlVariables;
