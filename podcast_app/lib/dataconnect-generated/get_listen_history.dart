...
class GetListenHistoryVariablesBuilder {
  ...
  GetListenHistoryVariablesBuilder(this._dataConnect, {required  this.userId,});
  Deserializer<GetListenHistoryData> dataDeserializer = (dynamic json)  => GetListenHistoryData.fromJson(jsonDecode(json));
  Serializer<GetListenHistoryVariables> varsSerializer = (GetListenHistoryVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<GetListenHistoryData, GetListenHistoryVariables>> execute() {
    return ref().execute();
  }

  QueryRef<GetListenHistoryData, GetListenHistoryVariables> ref() {
    GetListenHistoryVariables vars= GetListenHistoryVariables(userId: userId,);
    return _dataConnect.query("GetListenHistory", dataDeserializer, varsSerializer, vars);
  }
}
...
class GetListenHistoryListenHistories {
  ...
  episode = GetListenHistoryListenHistoriesEpisode.fromJson(json['episode']),
  progressSeconds = bigIntFromJson(json['progressSeconds']),
  finishedListening = json['finishedListening'] == null ? null : nativeFromJson<bool>(json['finishedListening']);
  @override
  bool operator ==(Object other) {
    ...
    final GetListenHistoryListenHistories otherTyped = other as GetListenHistoryListenHistories;
  ...
  @override
  int get hashCode => Object.hashAll([episode.hashCode, progressSeconds.hashCode, finishedListening.hashCode]);
...
class GetListenHistoryListenHistoriesEpisode {
  ...
  bool operator ==(Object other) {
    ...
    final GetListenHistoryListenHistoriesEpisode otherTyped = other as GetListenHistoryListenHistoriesEpisode;
...
class GetListenHistoryVariables {
  ...
  bool operator ==(Object other) {
    ...
    final GetListenHistoryVariables otherTyped = other as GetListenHistoryVariables;
