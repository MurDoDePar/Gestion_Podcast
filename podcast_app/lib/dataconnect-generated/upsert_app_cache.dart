...
class UpsertAppCacheVariablesBuilder {
  ...
  UpsertAppCacheVariablesBuilder(this._dataConnect, {required  this.id,required  this.data,required  this.updatedAt,});
  Deserializer<UpsertAppCacheData> dataDeserializer = (dynamic json)  => UpsertAppCacheData.fromJson(jsonDecode(json));
  Serializer<UpsertAppCacheVariables> varsSerializer = (UpsertAppCacheVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpsertAppCacheData, UpsertAppCacheVariables>> execute() {
    return ref().execute();
  }

  MutationRef<UpsertAppCacheData, UpsertAppCacheVariables> ref() {
    UpsertAppCacheVariables vars= UpsertAppCacheVariables(id: id,data: data,updatedAt: updatedAt,);
    return _dataConnect.mutation("UpsertAppCache", dataDeserializer, varsSerializer, vars);
  }
}
...
class UpsertAppCacheAppCacheUpsert {
  ...
  bool operator ==(Object other) {
    ...
    final UpsertAppCacheAppCacheUpsert otherTyped = other as UpsertAppCacheAppCacheUpsert;
...
class UpsertAppCacheData {
  ...
  appCache_upsert = UpsertAppCacheAppCacheUpsert.fromJson(json['appCache_upsert']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
