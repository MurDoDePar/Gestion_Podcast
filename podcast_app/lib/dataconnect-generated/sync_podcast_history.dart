...
class SyncPodcastHistoryVariablesBuilder {
  ...
  SyncPodcastHistoryVariablesBuilder(
    this._dataConnect, {
    required this.userId,
    required this.history,
  });
  Deserializer<SyncPodcastHistoryData> dataDeserializer =
      (dynamic json) => SyncPodcastHistoryData.fromJson(jsonDecode(json));
  Serializer<SyncPodcastHistoryVariables> varsSerializer =
      (SyncPodcastHistoryVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<SyncPodcastHistoryData, SyncPodcastHistoryVariables>>
      execute() {
    return ref().execute();
  }

  MutationRef<SyncPodcastHistoryData, SyncPodcastHistoryVariables> ref() {
    SyncPodcastHistoryVariables vars = SyncPodcastHistoryVariables(
      userId: userId,
      history: history,
    );
    return _dataConnect.mutation(
        "SyncPodcastHistory", dataDeserializer, varsSerializer, vars);
  }
}
...
class SyncPodcastHistoryVariables {
  ...
  bool operator ==(Object other) {
    ...
    final SyncPodcastHistoryVariables otherTyped =
        other as SyncPodcastHistoryVariables;
    return userId == otherTyped.userId && history == otherTyped.history;
  }
