...
class SubscribeToPodcastVariablesBuilder {
  ...
  final FirebaseDataConnect _dataConnect;  SubscribeToPodcastVariablesBuilder listOrder(int? t) {
   _listOrder.value = t;
   return this;
  }

  SubscribeToPodcastVariablesBuilder(this._dataConnect, {required  this.userId,required  this.podcastId,required  this.subscribedAt,});
  Deserializer<SubscribeToPodcastData> dataDeserializer = (dynamic json)  => SubscribeToPodcastData.fromJson(jsonDecode(json));
  Serializer<SubscribeToPodcastVariables> varsSerializer = (SubscribeToPodcastVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<SubscribeToPodcastData, SubscribeToPodcastVariables>> execute() {
    return ref().execute();
  }

  MutationRef<SubscribeToPodcastData, SubscribeToPodcastVariables> ref() {
    SubscribeToPodcastVariables vars= SubscribeToPodcastVariables(userId: userId,podcastId: podcastId,subscribedAt: subscribedAt,listOrder: _listOrder,);
    return _dataConnect.mutation("SubscribeToPodcast", dataDeserializer, varsSerializer, vars);
  }
}
...
class SubscribeToPodcastSubscriptionTypeUpsert {
  ...
  bool operator ==(Object other) {
    ...
    final SubscribeToPodcastSubscriptionTypeUpsert otherTyped = other as SubscribeToPodcastSubscriptionTypeUpsert;
...
class SubscribeToPodcastData {
  ...
  subscriptionType_upsert = SubscribeToPodcastSubscriptionTypeUpsert.fromJson(json['subscriptionType_upsert']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
...
class SubscribeToPodcastVariables {
  ...
  subscribedAt = Timestamp.fromJson(json['subscribedAt']) {
    ...
    listOrder.value = json['listOrder'] == null ? null : nativeFromJson<int>(json['listOrder']);
  ...
  bool operator ==(Object other) {
    ...
    final SubscribeToPodcastVariables otherTyped = other as SubscribeToPodcastVariables;
    return userId == otherTyped.userId && 
    podcastId == otherTyped.podcastId && 
  ...
  @override
  int get hashCode => Object.hashAll([userId.hashCode, podcastId.hashCode, subscribedAt.hashCode, listOrder.hashCode]);
