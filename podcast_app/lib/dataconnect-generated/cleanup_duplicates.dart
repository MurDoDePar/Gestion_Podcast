...
class CleanupDuplicatesVariablesBuilder {
  ...
  CleanupDuplicatesVariablesBuilder(
    this._dataConnect,
  );
  Deserializer<CleanupDuplicatesData> dataDeserializer =
      (dynamic json) => CleanupDuplicatesData.fromJson(jsonDecode(json));
  ...
  MutationRef<CleanupDuplicatesData, void> ref() {
    return _dataConnect.mutation(
        "CleanupDuplicates", dataDeserializer, emptySerializer, null);
  }
}
  ...
  CleanupDuplicatesData.fromJson(dynamic json)
      : cleanEpisodes = json['cleanEpisodes'] == null
        ...
        cleanUsers = json['cleanUsers'] == null
            ? null
            : nativeFromJson<int>(json['cleanUsers']);
  @override
