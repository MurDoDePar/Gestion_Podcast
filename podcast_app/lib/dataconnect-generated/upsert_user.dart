...
class UpsertUserVariablesBuilder {
  ...
  UpsertUserVariablesBuilder(this._dataConnect, {required  this.id,required  this.googleId,required  this.displayName,required  this.createdAt,});
  ...
  MutationRef<UpsertUserData, UpsertUserVariables> ref() {
    UpsertUserVariables vars= UpsertUserVariables(id: id,googleId: googleId,displayName: displayName,email: _email,photoUrl: _photoUrl,createdAt: createdAt,);
...
class UpsertUserVariables {
  ...
  @override
  int get hashCode => Object.hashAll([id.hashCode, googleId.hashCode, displayName.hashCode, email.hashCode, photoUrl.hashCode, createdAt.hashCode]);
