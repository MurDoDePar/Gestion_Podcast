...
class UpsertUserVariablesBuilder {
  ...
  UpsertUserVariablesBuilder(this._dataConnect, {required  this.googleId,required  this.displayName,required  this.createdAt,});
  ...
  MutationRef<UpsertUserData, UpsertUserVariables> ref() {
    UpsertUserVariables vars= UpsertUserVariables(id: _id,googleId: googleId,displayName: displayName,email: _email,photoUrl: _photoUrl,createdAt: createdAt,);
