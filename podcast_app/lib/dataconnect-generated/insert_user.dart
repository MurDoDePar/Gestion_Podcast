...
class InsertUserVariablesBuilder {
  ...
  final FirebaseDataConnect _dataConnect;  InsertUserVariablesBuilder email(String? t) {
   _email.value = t;
   return this;
  }
  ...
  InsertUserVariablesBuilder(this._dataConnect, {required  this.googleId,required  this.displayName,required  this.createdAt,});
  ...
  MutationRef<InsertUserData, InsertUserVariables> ref() {
    InsertUserVariables vars= InsertUserVariables(googleId: googleId,displayName: displayName,email: _email,photoUrl: _photoUrl,createdAt: createdAt,);
...
class InsertUserVariables {
  ...
  @override
  int get hashCode => Object.hashAll([googleId.hashCode, displayName.hashCode, email.hashCode, photoUrl.hashCode, createdAt.hashCode]);
