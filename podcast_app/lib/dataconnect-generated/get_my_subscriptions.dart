...
class GetMySubscriptionsVariablesBuilder {
  ...
  GetMySubscriptionsVariablesBuilder(this._dataConnect, {required  this.userId,});
  Deserializer<GetMySubscriptionsData> dataDeserializer = (dynamic json)  => GetMySubscriptionsData.fromJson(jsonDecode(json));
  Serializer<GetMySubscriptionsVariables> varsSerializer = (GetMySubscriptionsVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<GetMySubscriptionsData, GetMySubscriptionsVariables>> execute() {
    return ref().execute();
  }

  QueryRef<GetMySubscriptionsData, GetMySubscriptionsVariables> ref() {
    GetMySubscriptionsVariables vars= GetMySubscriptionsVariables(userId: userId,);
    return _dataConnect.query("GetMySubscriptions", dataDeserializer, varsSerializer, vars);
  }
}
...
class GetMySubscriptionsSubscriptionTypes {
  ...
  podcast = GetMySubscriptionsSubscriptionTypesPodcast.fromJson(json['podcast']);
  @override
  bool operator ==(Object other) {
    ...
    final GetMySubscriptionsSubscriptionTypes otherTyped = other as GetMySubscriptionsSubscriptionTypes;
...
class GetMySubscriptionsSubscriptionTypesPodcast {
  ...
  bool operator ==(Object other) {
    ...
    final GetMySubscriptionsSubscriptionTypesPodcast otherTyped = other as GetMySubscriptionsSubscriptionTypesPodcast;
...
class GetMySubscriptionsVariables {
  ...
  bool operator ==(Object other) {
    ...
    final GetMySubscriptionsVariables otherTyped = other as GetMySubscriptionsVariables;
