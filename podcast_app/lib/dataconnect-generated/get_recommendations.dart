...
class GetRecommendationsVariablesBuilder {
  ...
  GetRecommendationsVariablesBuilder(this._dataConnect, {required  this.podcastId,});
  ...
  QueryRef<GetRecommendationsData, GetRecommendationsVariables> ref() {
    GetRecommendationsVariables vars= GetRecommendationsVariables(podcastId: podcastId,);
