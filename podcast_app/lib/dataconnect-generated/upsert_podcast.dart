...
class UpsertPodcastVariablesBuilder {
  ...
  Optional<List<String>> _categories = Optional.optional(listDeserializer(nativeFromJson), listSerializer(nativeToJson));
  Timestamp createdAt;
  ...
  UpsertPodcastVariablesBuilder(this._dataConnect, {required  this.title,required  this.feedUrl,required  this.createdAt,});
  Deserializer<UpsertPodcastData> dataDeserializer = (dynamic json)  => UpsertPodcastData.fromJson(jsonDecode(json));
  Serializer<UpsertPodcastVariables> varsSerializer = (UpsertPodcastVariables vars) => jsonEncode(vars.toJson());
  ...
  MutationRef<UpsertPodcastData, UpsertPodcastVariables> ref() {
    UpsertPodcastVariables vars= UpsertPodcastVariables(id: _id,title: title,feedUrl: feedUrl,description: _description,imageUrl: _imageUrl,author: _author,categories: _categories,createdAt: createdAt,);
    return _dataConnect.mutation("UpsertPodcast", dataDeserializer, varsSerializer, vars);
  }
}
...
class UpsertPodcastPodcastUpsert {
  ...
  bool operator ==(Object other) {
    ...
    final UpsertPodcastPodcastUpsert otherTyped = other as UpsertPodcastPodcastUpsert;
...
class UpsertPodcastData {
  ...
  podcast_upsert = UpsertPodcastPodcastUpsert.fromJson(json['podcast_upsert']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
...
class UpsertPodcastVariables {
  ...
  createdAt = Timestamp.fromJson(json['createdAt']) {
    ...
    categories = Optional.optional(listDeserializer(nativeFromJson), listSerializer(nativeToJson));
    categories.value = json['categories'] == null ? null : (json['categories'] as List<dynamic>)
  ...
  @override
  int get hashCode => Object.hashAll([id.hashCode, title.hashCode, feedUrl.hashCode, description.hashCode, imageUrl.hashCode, author.hashCode, categories.hashCode, createdAt.hashCode]);
