...
class GetEpisodesByPodcastVariablesBuilder {
  ...
  GetEpisodesByPodcastVariablesBuilder(this._dataConnect, {required  this.podcastId,});
  Deserializer<GetEpisodesByPodcastData> dataDeserializer = (dynamic json)  => GetEpisodesByPodcastData.fromJson(jsonDecode(json));
  Serializer<GetEpisodesByPodcastVariables> varsSerializer = (GetEpisodesByPodcastVariables vars) => jsonEncode(vars.toJson());
  Future<QueryResult<GetEpisodesByPodcastData, GetEpisodesByPodcastVariables>> execute() {
    return ref().execute();
  }

  QueryRef<GetEpisodesByPodcastData, GetEpisodesByPodcastVariables> ref() {
    GetEpisodesByPodcastVariables vars= GetEpisodesByPodcastVariables(podcastId: podcastId,);
    return _dataConnect.query("GetEpisodesByPodcast", dataDeserializer, varsSerializer, vars);
  }
}
...
class GetEpisodesByPodcastEpisodes {
  ...
  bool operator ==(Object other) {
    ...
    final GetEpisodesByPodcastEpisodes otherTyped = other as GetEpisodesByPodcastEpisodes;
  ...
  @override
  int get hashCode => Object.hashAll([id.hashCode, title.hashCode, audioUrl.hashCode, duration.hashCode, description.hashCode, imageUrl.hashCode, publishedAt.hashCode]);
...
class GetEpisodesByPodcastData {
  ...
  bool operator ==(Object other) {
    ...
    final GetEpisodesByPodcastData otherTyped = other as GetEpisodesByPodcastData;
...
class GetEpisodesByPodcastVariables {
  ...
  bool operator ==(Object other) {
    ...
    final GetEpisodesByPodcastVariables otherTyped = other as GetEpisodesByPodcastVariables;
