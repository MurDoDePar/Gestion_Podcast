...
class DiscoverTab extends StatefulWidget {
  final AffinityTabService service;

  DiscoverTab({
    super.key,
    AffinityTabService? service,
  }) : service = service ?? locator<AffinityTabService>();
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        final recommended = widget.service.recommendedPodcasts;
