...
private class ExampleConnectorImpl(
  override val dataConnect: com.google.firebase.dataconnect.FirebaseDataConnect
    ...
    override val getLatestSubscribedEpisodes by lazy(LazyThreadSafetyMode.PUBLICATION) {
      GetLatestSubscribedEpisodesQueryImpl(this)
    }
...
private class GetEpisodesByPodcastQueryImpl(
  ...
  GetEpisodesByPodcastQuery,
  ExampleConnectorGeneratedQueryImpl<
      GetEpisodesByPodcastQuery.Data,
      GetEpisodesByPodcastQuery.Variables
  >(
    connector,
    GetEpisodesByPodcastQuery.Companion.operationName,
    GetEpisodesByPodcastQuery.Companion.dataDeserializer,
    GetEpisodesByPodcastQuery.Companion.variablesSerializer,
  )


private class GetLatestSubscribedEpisodesQueryImpl(
  connector: ExampleConnector
):
  GetLatestSubscribedEpisodesQuery,
  ExampleConnectorGeneratedQueryImpl<
      GetLatestSubscribedEpisodesQuery.Data,
      GetLatestSubscribedEpisodesQuery.Variables
  >(
    connector,
    GetLatestSubscribedEpisodesQuery.Companion.operationName,
    GetLatestSubscribedEpisodesQuery.Companion.dataDeserializer,
    GetLatestSubscribedEpisodesQuery.Companion.variablesSerializer,
  )
