...
const getPodcastByFeedUrlRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetPodcastByFeedUrl', inputVars);
}
getPodcastByFeedUrlRef.operationName = 'GetPodcastByFeedUrl';
exports.getPodcastByFeedUrlRef = getPodcastByFeedUrlRef;

exports.getPodcastByFeedUrl = function getPodcastByFeedUrl(dcOrVars, varsOrOptions, options) {
